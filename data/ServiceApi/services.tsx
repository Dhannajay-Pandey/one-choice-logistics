...
export const services = [
  {
    ...
    description:
      "Comprehensive maritime solutions connecting global hubs to West Africa.",
  ...
  },
  {
    ...
    title: "Air Freight",
    description:
      "Rapid air cargo services for urgent commercial and personal shipments.",
  ...
  },
  {
    ...
    description:
      "Navigating complex regulations to ensure smooth import and export.",
  ...
  },
  {
    ...
    description:
      "Secure storage and efficient distribution networks.",
  ...
  },
  {
    ...
    description:
      "Strategic advice to optimize your logistics operations.",
